...
Arguments:
    ...
    --repo       "owner/repo"
    --changelog  path to a notes file (e.g. docs/RELEASE_NOTES.md); split
                 on a line that is exactly "---" — Persian before, English
                 after. Missing file = only the APK is posted (no reply).
