 ...
 *   1. Runs the mhrv-f Rust proxy (HTTP + SOCKS5 on 127.0.0.1).
...
class MhrvVpnService : VpnService() {
    ...
    private fun startEverything() {
        ...
        startForeground(NOTIF_ID, buildNotif(socks5Port))
    ...
    private fun buildNotif(socks5Port: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText(getString(R.string.notif_vpn_text, socks5Port))
