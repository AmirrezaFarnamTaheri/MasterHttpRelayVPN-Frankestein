...
/**
 * JNI bindings for the mhrv_jni Rust library crate. The crate is compiled to
 * libmhrv_jni.so and loaded at app start.
 *
...
object Native {
    ...
    /** mhrv_jni crate version. Smoke test for JNI linkage. */
    ...
    /**
     * Ask GitHub's Releases API whether a newer version of mhrv-f is
