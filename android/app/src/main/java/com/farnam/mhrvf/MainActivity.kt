...
import com.farnam.mhrvf.ui.CaInstallOutcome
import com.farnam.mhrvf.ui.HomeScreen
import com.farnam.mhrvf.ui.theme.MhrvTheme
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleDeepLink(intent: Intent?) {
        ...
        if (data.scheme !in setOf("mhrvf", "mhrv-rs")) return
