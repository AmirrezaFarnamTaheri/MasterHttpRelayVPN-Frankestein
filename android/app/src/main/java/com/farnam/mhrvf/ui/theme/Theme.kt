package com.farnam.mhrvf.ui.theme
...
val AccentBlue = Color(0xFF569ECD)
val AccentHover = Color(0xFFE2AA5C)
...
val CardFill = Color(0xFF1F1E1D)
val CardStroke = Color(0xFF403C36)
...
val BgDark = Color(0xFF121110)

// Text shades — `egui::Color32::from_gray(200)` etc.
val TextPrimary = Color(0xFFE8E5DE)
val TextSecondary = Color(0xFFAEADA8)
val TextLabel = Color(0xFFCFC8BC)
...
private val MhrvTypography = BaseTypography.copy(
    ...
    bodyMedium = BaseTypography.bodyMedium.copy(lineHeight = 23.sp),
    bodySmall = BaseTypography.bodySmall.copy(lineHeight = 19.sp),
