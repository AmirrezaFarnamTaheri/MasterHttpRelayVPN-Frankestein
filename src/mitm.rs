...
pub const CERT_NAME: &str = crate::branding::PRODUCT_NAME;
...
impl MitmCertManager {
    ...
    fn issue_leaf(&self, domain: &str) -> Result<(CertificateDer<'static>, Vec<u8>), MitmError> {
        ...
        // to add them explicitly. They must be present for browser trust.
        params.key_usages = vec![
            KeyUsagePurpose::DigitalSignature,
...
mod tests {
    ...
    fn leaf_has_serverauth_eku_and_key_usage() {
        // rcgen's CertificateParams::default()
